...
router.post('/create', async function(req, res) {
  try{
        await ordr_banner_detailsModel.create({
...
router.post('/getting_shop_name', function (req, res) {
        ordr_banner_detailsModel.findOne({shop_link_name:req.body.shop_link_name}, function (err, StateList) {
          let a = {
...
router.get('/deletes', function (req, res) {
      ordr_banner_detailsModel.remove({}, function (err, user) {
...
router.post('/getlist_id', function (req, res) {
        ordr_banner_detailsModel.find({vendor_id:req.body._id}, function (err, StateList) {
...
router.get('/getlist', function (req, res) {
        ordr_banner_detailsModel.find({}, function (err, Functiondetails) {
...
router.post('/edit', function (req, res) {
        ordr_banner_detailsModel.findByIdAndUpdate(req.body._id, req.body, {new: true}, function (err, UpdatedDetails) {
...
router.post('/delete', function (req, res) {
      ordr_banner_detailsModel.findByIdAndRemove(req.body.Activity_id, function (err, user) {
          if (err) return res.json({Status:"Failed",Message:"Internal Server Error", Data : {},Code:500});
