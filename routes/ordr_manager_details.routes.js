...
router.post('/create', async function(req, res) {
  try{
await ordr_manager_detailsModel.create({
...
router.post('/manager_login', function (req, res) {
        ordr_manager_detailsModel.findOne({res_id:req.body.res_id,manager_email:req.body.manager_email,manager_password:req.body.manager_password}, function (err, StateList) {
          let a = {
...
router.post('/getting_shop_name', function (req, res) {
        ordr_manager_detailsModel.findOne({shop_link_name:req.body.shop_link_name}, function (err, StateList) {
          let a = {
            Vendor_details : StateList
          }
          res.json({Status:"Success",Message:"company type List", Data : a ,Code:200});
...
router.post('/forgotpassword', function (req, res) {
        ordr_manager_detailsModel.findOne({vendor_email:req.body.vendor_email}, function (err, StateList) {
          let a = {
            Vendor_details : StateList
          }
          res.json({Status:"Success",Message:"company type List", Data : a ,Code:200});
...
router.get('/deletes', function (req, res) {
      ordr_manager_detailsModel.remove({}, function (err, user) {
...
router.post('/getlist_id', function (req, res) {
        ordr_manager_detailsModel.find({Person_id:req.body.Person_id}, function (err, StateList) {
...
router.get('/getlist', function (req, res) {
        ordr_manager_detailsModel.find({}, function (err, Functiondetails) {
...
router.post('/edit', function (req, res) {
        ordr_manager_detailsModel.findByIdAndUpdate(req.body._id, req.body, {new: true}, function (err, UpdatedDetails) {
